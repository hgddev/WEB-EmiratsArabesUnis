...
* **01. Design UI/UX :** Conception d'une maquette complète sur **Figma** en amont de l'intégration afin de valider l'ergonomie, la mise en page et la cohérence de la charte graphique.
* **02. Structure & Sémantique :** Utilisation rigoureuse des balises sémantiques **HTML5** pour garantir une structure propre, un bon référencement naturel (SEO) et une accessibilité optimale.
* **03. Stylisation & Responsive :** Intégration fine en **CSS3** pour retranscrire fidèlement l'identité visuelle de la maquette, avec une adaptation fluide sur tous les types d'écrans (Mobiles, Tablettes, Desktops).
